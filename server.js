...
graph.addEdge("414호", "415호", 6.5);
graph.addEdge("415호", "4층 제 5 계단", 1);
...
graph.addEdge("518호", "519호", 3);
graph.addEdge("519호", "520호", 3);
graph.addEdge("521호", "522호", 3);
graph.addEdge("523호", "524호", 3);
graph.addEdge("524호", "525호", 3);
...
graph.addEdge("5층 제 3 엘리베이터 2호", "513호", 7);
